    ...
    tabs: [
      {
        ...
        image: 'https://eticare.com.pe/ifics/pictures/solucionesConsultoria.webp'
      },
      {
        ...
        image: 'https://eticare.com.pe/ifics/pictures/solucionesTecnologia.webp'
      },
      {
        title: 'Capacitación',
        description: [
        ...
        image: 'https://eticare.com.pe/ifics/pictures/solucionesEconomicasEspeciales.webp'
      }
    ],
    ...
    innovacionEficiencia: [
      {
        color: 'blue',
        titleOne: '',
        titleTwo: 'Mejora de procedimientos y regulaciones',
        text: [
          'Las autoridades que regulan el ingreso, permanencia y salida del territorio, de mercancías restringidas como alimentos o medicamentos, o la prestación de servicios a la carga, son agentes activos de la facilitación comercial, pero requieren una mejor articulación entre sí y fortalecimiento institucional para atender la creciente demanda de servicios.',
        ...
        image1:
          'https://eticare.com.pe/ifics/pictures/mejoraDeProcedimientos.webp',
      },
      {
        color: 'orange',
        titleOne: '',
        titleTwo: 'Plataformas Digitales y Ventanillas Únicas',
        text: [
          'Diseñamos y proveemos plataformas digitales de comercio transfronterizo y ventanillas únicas. Centralizamos y digitalizamos todos los procesos de facilitación del comercio y logísticos necesarios para realizar operaciones de comercio exterior de forma rápida, eficiente y segura. Damos servicios de reingeniería y automatización de procesos y digitalización de documentos.',
          'La Ventanilla Única de Comercio Exterior es uno de los instrumentos más representativos de la facilitación del comercio y su plataforma debe servir para acelerar la optimización de los procesos y trámites y, en general, mejorar la gestión del comercio.',
        ],
        image1:
          'https://eticare.com.pe/ifics/pictures/plataformasDigitales.webp',
      },
      {
        color: 'blue',
        titleOne: '',
        titleTwo: 'Procesos logísticos y servicio aduanero',
        text: [
          'Las ineficiencias en la logística pueden tener efectos equivalentes a las barreras arancelarias, por tanto, analizamos dichos procesos en el ámbito portuario y aeroportuario para promover una óptima cadena de suministro. La logística del transporte internacional debe funcionar en armonía con los procesos aduaneros.',
          'La Aduana cumple la función pública más importante en la implementación de la facilitación del comercio, por su responsabilidad inherente en el tráfico de bienes. Un tercio del tiempo de despacho lo ocupa el proceso aduanero de modo que cualquier defecto en su servicio repercute negativamente en la competitividad del país (Banco Mundial).',
        ],
        image1:
          'https://eticare.com.pe/ifics/pictures/procesosLogisticos.webp',
      },
      {
        color: 'orange',
        titleOne: '',
        titleTwo: 'Barreras no arancelarias y sistema de la calidad',
        text: [
          'Las barreras no arancelarias adoptan distintas formas de restricción al comercio, a veces difícilmente identificables. ',
        ...
        image1:
          'https://eticare.com.pe/ifics/pictures/BarrerasNoArancelarias.webp',
      },
      {
        color: 'blue',
        titleOne: '',
        titleTwo: 'Zonas Económicas Especiales',
        text: [
          'Las Zonas Económicas Especiales o Zonas Francas son un importante mecanismo de atracción de inversión, diversificación industrial e internacionalización de negocios y su crecimiento en el mundo es constante, especialmente en las economías emergentes. Nuestra alianza con la prestigiosa firma colombiana Araujo Ibarra & Asociados (una de las consultoras líderes en el mundo sobre ZEE) nos permite brindar servicios de alta especialización en la instalación y expansión de las inversiones en las ZEE, asistiendo a clientes en sus necesidades operativas, logísticas y de cumplimiento de las normas que rigen el ingreso, permanencia y salida de mercancías; asimismo, asesoramos en el diseño de políticas de implementación de las ZEE con arreglo a las mejores prácticas internacionales.',
        ],
        image1:
          'https://eticare.com.pe/ifics/pictures/zonasEconomicasEspeciales.webp',
      },
    ],
    areasEstrategicas: {
  ...
  EN: {
    ...
    tabs: [
      ...
      },
      {
        ...
        image: 'https://eticare.com.pe/ifics/pictures/solucionesCapacitacion.webp'
      }
    ],
    serviciosDeExcelencia: {
    ...
    innovacionEficiencia: [
      {
        ...
        image1: 'https://eticare.com.pe/ifics/pictures/mejoraDeProcedimientos.webp'
      },
      {
        color: 'orange',
        titleOne: '',
        ...
        image1: 'https://eticare.com.pe/ifics/pictures/plataformasDigitales.webp'
      },
      {
        color: 'blue',
        titleOne: '',
        ...
        image1: 'https://eticare.com.pe/ifics/pictures/procesosLogisticos.webp'
      },
      {
        color: 'orange',
        titleOne: '',
        ...
        image1: 'https://eticare.com.pe/ifics/pictures/BarrerasNoArancelarias.webp'
      },
      {
        color: 'blue',
        titleOne: '',
        ...
        image1: 'https://eticare.com.pe/ifics/pictures/zonasEconomicasEspeciales.webp'
      }
    ],
    areasEstrategicas: {
